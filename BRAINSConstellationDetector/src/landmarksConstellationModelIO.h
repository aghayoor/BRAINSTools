    ...
    try
     ...
     // we should stop here and return a segfault with a proper message.
      ...
      this->Read<unsigned int>(input, this->m_NumRotationSteps);
        ...
        // TEMP: just keep for temporary debugging
        // TODO: delete these!
      std::cout << "m_SearchboxDims: " << this->m_SearchboxDims << std::endl;
      std::cout << "m_ResolutionUnits: " << this->m_ResolutionUnits << std::endl;
      std::cout << "m_NumDataSets: " << this->m_NumDataSets << std::endl;
      std::cout << "m_NumRotationSteps: " << this->m_NumRotationSteps << std::endl;
